...
class Usuario
{
    ...
    public function salvar(): void
    {
        ...
        $stm = $con->prepare('INSERT INTO users(email, nome, senha) VALUES(:email, :nome, :senha)');
    ...
    {
        $con = Database::getConnection();
        $stm = $con->prepare('SELECT email, nome, senha FROM users WHERE email = :email');
    ...
    {
        $con = Database::getConnection();
        $stm = $con->prepare('SELECT email, nome, senha FROM users');
        $stm->execute();
    ...
    public function deletar($email)
    {
        ...
        $con = Database::getConnection();
        $stm = $con->prepare('DELETE FROM users WHERE email = :email');
        $stm->bindParam(':email', $email);
        $stm->execute();
    }
}
